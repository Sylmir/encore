    ...
    do encorecPath <- getExecutablePath
       ...
       let encoreNames =
           ...
           customFlags = case find isCustomFlags options of
                           ...
                           Nothing                -> ""
           flags = "-std=gnu11 -Wall -fms-extensions -Wno-format -Wno-microsoft -Wno-parentheses-equality -Wno-unused-variable -Wno-unused-value" <+> customFlags <+> "-lpthread -ldl -lm -Wno-attributes -ferror-limit=0"
           oFlag = "-o" <+> execName
