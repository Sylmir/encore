...
getChildren MessageSendFlow {target, args} = target : args
...
putChildren (target : args) e@(MessageSendFlow {}) = e{target = target, args = args}
...
putChildren _ e@(MessageSendFlow {}) = error "'putChildren l MessageSendFlow' expects l to have at least 1 element"
